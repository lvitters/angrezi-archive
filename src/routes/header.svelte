...
<nav class="mx-4 mt-6 flex border-x border-t border-black p-4">
	<a href="http://radioangrezi.de">
		<div
			id={chooseRandomFont()}
			class="ml-10 box-border flex h-[60px] w-[300px] cursor-pointer justify-center p-1 text-center outline hover:text-[#0000ff]"
	...
	<div
		id={chooseRandomFont()}
		class="ml-10 box-border flex h-[60px] w-[300px] cursor-pointer items-center justify-center p-1 text-[black] outline hover:text-[#0000ff]"
		style="box-shadow: 5px 5px;">
		ANGREZI ARCHIVE
	</div>
</nav>
