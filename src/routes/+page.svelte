...
<div class="wrapper">
	<header class="main-head">
		<div class="marquee-wrapper">
			<div class="marquee">
				<p class="now_playing">
					Welcome to Radio Angrezi! - <a href="https://t.me/radioangrezi"
						>Notification when on air?</a
					>
				</p>
			</div>
		</div>
		...
		<div class="notification-section">
			...
			<div class="mailinglist-form flex-item grid-outline-block">
				<form
					action="https://mailman.zfn.uni-bremen.de/cgi-bin/mailman/subscribe/ra-friends"
					method="POST"
					target="_blank"
				...
				>
					<input
						type="email"
						placeholder="become a friend of the mailing list"
						name="email"
						autocomplete="off"
						autocorrect="off"
						autocapitalize="off"
				...
				<div class="content-inner">
					<div class="shoutbox-wrapper">
						...
						<iframe
							width="100%"
							height="960px"
							src="http://talk.radioangrezi.de/embed.html?1705674130862506274"
							border="0"
							outline="0"
							loading="lazy"
						></iframe>
	...
	<footer id="anchor-footer" class="site-footer">
		<p>
			Radio Angrezi is an experimental ground for sound, music, voice and live performance. It
			broadcasts weekly from its studio at Speicher XI (Bremen) on radioangrezi.de, as well as
			occasionally on 92,5 FM, receivable in the Bremen and the surrounding area. In addition
			special broadcasts covering concerts, lectures, presentations and exhibition openings are
			produced regularly.
			<br /><br />
			Radio Angrezi is an autonomous student collective, spanning all disciplines, study departments
			and multiple languages. It is open for students, teachers and guests. It aims to rise questions,
			develop new conditions, shapes and formats, to perform and to broadcast – collectively or individually
			– to listen, to observe and to discuss.
			<br /><br />
			Interested in broadcasting, performing, supporting, mixing or just hanging out? Drop by in Segment
			7 in Speicher XI or send a line to
			<a class="black-link" href="mailto:radioangrezi@hfk-bremen.de">radioangrezi@hfk-bremen.de</a>
		</p>
		<p>Visit the studio during the live streams:<br /></p>
		<address>
			Radio Angrezi<br />
		...
		<p>
			Email: <a class="black-link" href="mailto:radioangrezi@hfk-bremen.de"
				>radioangrezi@hfk-bremen.de</a
			><br />
...
<style>
	...
	*:after {
	...
	.mailinglist-form .newsletter input,
	...
	.mailinglist-form a.btn::placeholder,
	.mailinglist-form input::placeholder,
	.mailinglist-form button::placeholder {
		color: black;
	}

	.mailinglist-form a.btn:focus,
	.mailinglist-form input:focus,
	.mailinglist-form button:focus {
		outline-style: dotted;
	}

	.mailinglist-form a.btn:focus::placeholder,
	.mailinglist-form a.btn:focus::-webkit-input-placeholder,
	.mailinglist-form input:focus::placeholder,
	.mailinglist-form input:focus::-webkit-input-placeholder,
	.mailinglist-form button:focus::placeholder,
	.mailinglist-form button:focus::-webkit-input-placeholder {
		color: transparent;
	}

	.mailinglist-form a.btn:active::placeholder,
	.mailinglist-form input:active::placeholder,
	.mailinglist-form button:active::placeholder {
		color: black;
	}
	...
	@font-face {
		...
		src:
			url('fonts/Sporting_Grotesque-Bold_web.eot?#iefix') format('embedded-opentype'),
	...
	@font-face {
		...
		src:
			url('fonts/savate-regular-webfont.eot?#iefix') format('embedded-opentype'),
	...
	@font-face {
		...
		src:
			url('fonts/VG5000-Regular_web.eot?#iefix') format('embedded-opentype'),
	...
	@font-face {
		...
		src:
			url('fonts/Millimetre/Bold/Millimetre-Bold_web.eot?#iefix') format('embedded-opentype'),
	...
	@font-face {
		...
		src:
			url('fonts/terminal-grotesque-webfont.eot?#iefix') format('embedded-opentype'),
