			...
			<div id="player">
				<div class="airtime_player">
					<div class="airtime_box">
						<div id="play" class="play_button" onclick="musesPlayer.toggle()">START LIVESTREAM</div>
					</div>
				</div>
			</div>
			<div id="muses_skin">
...
<article class='show-item'>
	<div class='headlines'>
	<img class='pixel' src='assets/images/MrPixel-moon.svg'>
...
<article class='show-item'>
	<div class='headlines'>
	<img class='pixel' src='../lib/MrPixel-tear.svg'>
